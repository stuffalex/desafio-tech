...
revision = '202310241050'  # Update this to a unique ID
down_revision = None # Set this to the previous revision ID, if any
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    op.create_table(
        ...
        sa.Column('custoKwh', sa.Numeric, nullable=True),
